...
@pytest.mark.baseline_images("all_weights", "all_weights_Mutations", "all_weights_Mutations_mRNA")
...
@pytest.mark.baseline_images("factor")
def test_factor(cll_model):
    return mfl.pl.factor(cll_model)


@pytest.mark.baseline_images(
    "top_weights",
...
@pytest.mark.baseline_images("factors_covariate-cov0", "factors_covariate-cov1-cov0")
